...
const projects: Project[] = [
  ...
  {
    name: 'SaveMyTime Dashboards',
    category: 'Dashboard',
    description:
      'Enterprise-grade analytics dashboard suite with real-time data visualization, role-based access control, and integrated AI voice agent management for business operations.',
    results: [
      'Real-time operational analytics',
      'Role-based multi-tenant architecture',
      'Integrated ElevenLabs voice management',
    ],
    tags: ['Next.js 15', 'Supabase', 'ElevenLabs API'],
    impact: 'Gave operations teams a single pane of glass for AI-powered business intelligence.',
    url: 'https://www.savemytime.cloud',
    featured: true,
