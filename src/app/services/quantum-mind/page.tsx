  ...
  return (
    <main className="flex flex-col">
      ...
      >
        ...
        <Link
          href="/services"
          className="relative text-sm tracking-widest uppercase text-gray-300 hover:text-white transition-colors duration-300 after:absolute after:bottom-[-4px] after:left-0 after:h-[1px] after:w-0 after:bg-[#4a9eff] hover:after:w-full after:transition-all after:duration-300"
        >
          All Services
        </Link>
      </motion.nav>
        ...
        <div className="mx-auto max-w-6xl px-6 md:px-12 py-12 md:py-16">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <p className="text-sm text-gray-500">
              <span className="text-gray-400">HEAVEN INTERACTIVE</span> / Quantum Mind
            </p>
            <Link
              href="/"
              className="text-sm text-gray-500 hover:text-[#4a9eff] transition-colors duration-300"
            >
              Back to Home
            </Link>
          </div>
