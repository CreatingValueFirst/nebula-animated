    ...
    <main className="flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 hidden sm:flex items-center gap-8">
          <Link href="/" className="relative text-sm tracking-widest uppercase text-gray-300 hover:text-white transition-colors duration-300 after:absolute after:bottom-[-4px] after:left-0 after:h-[1px] after:w-0 after:bg-[#c4623a] hover:after:w-full after:transition-all after:duration-300">
            Home
          </Link>
          <Link href="/services" className="relative text-sm tracking-widest uppercase text-gray-300 hover:text-white transition-colors duration-300 after:absolute after:bottom-[-4px] after:left-0 after:h-[1px] after:w-0 after:bg-[#c4623a] hover:after:w-full after:transition-all after:duration-300">
            Services
          </Link>
          <Link href="/contact" className="relative text-sm tracking-widest uppercase text-gray-300 hover:text-white transition-colors duration-300 after:absolute after:bottom-[-4px] after:left-0 after:h-[1px] after:w-0 after:bg-[#c4623a] hover:after:w-full after:transition-all after:duration-300">
            Contact
          </Link>
        </div>
      </motion.nav>
      ...
      <section ref={heroRef} className="relative h-[90vh] min-h-[700px] w-full overflow-hidden">
        ...
        >
          ...
          >
            <Link href="/services" className="hover:text-[#c4623a] transition-colors duration-300">Services</Link>
            <span>/</span>
            <span className="text-[#c4623a]">Voice Cosmos</span>
          </motion.div>
        ...
        <div className="mx-auto max-w-6xl px-6 md:px-12 py-12 md:py-16">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              <Link href="/services" className="text-sm text-gray-500 hover:text-[#c4623a] transition-colors duration-300">Services</Link>
              <Link href="/contact" className="text-sm text-gray-500 hover:text-[#c4623a] transition-colors duration-300">Contact</Link>
            </div>
          </div>
        </div>
      </footer>
